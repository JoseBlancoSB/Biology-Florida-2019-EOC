# 1)  Downloading Biology, 2019 Data from Florida Dept. of Educ.
#
#   library(downloader)
#
#   url <- "https://www.fldoe.org/core/fileparse.php/5668/urlt/54Spring19Bio1SRS.xls"
#
#   filename <- basename(url)
#
#   set the working directory you want to download to.  In this case,
#   > setwd("/home/jose/R/data/github/Biology-Florida-2019-EOC")
#
...
#
#   basefile <- read_excel("54Spring19Bio1SRS.xls", skip = 4)
#
#   This command creates a dataframe in R called "basefile"
#   in the working directory.  You can see that it has 1136 observations (rows) 
...
#
#     What does it mean to "clean the data"?  Well, at this stage of
...
#   as a value.  Schools where fewer than 10 students took the Biology EOC have an
...
#   The above expression filtered out all the '*' values.  Now we have a 
#   dataframe of 902 observations.
...
#    [11] "4"                               "5"  
#
#   alg2019 <- rename(alg2019, 'dist_num' = 'District Number',
...
#
#   Creates a data frame with the 3 observations I need:  state, county, school.
...
#   Rename the row names (observations) for easy reading -- get rid of caps.
...
ggplot(data = my_data, aes(x=sch_name, y=mean_scl)) + 
  ...
  theme_minimal() +
  coord_cartesian(ylim = c(325, 475)) +
  ggtitle(" Comparison of George Washington Carver Middle School\n to State and County Results, Biology EOC, 2019") +
  xlab(NULL) + 
